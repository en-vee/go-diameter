...
[![Go Report Card](https://goreportcard.com/badge/github.com/en-vee/go-diameter)](https://goreportcard.com/report/github.com/en-vee/go-diameter)
[![Test Status](https://github.com/en-vee/go-diameter/actions/workflows/test.yaml/badge.svg)](https://github.com/en-vee/go-diameter/actions/workflows/test.yaml)
[![Go Reference](https://pkg.go.dev/badge/github.com/en-vee/go-diameter/v4.svg)](https://pkg.go.dev/github.com/en-vee/go-diameter/v4)
[![Latest](https://img.shields.io/github/v/tag/en-vee/go-diameter.svg?sort=semver&style=flat-square&label=latest)](https://github.com/en-vee/go-diameter/tags)

Package [go-diameter](https://pkg.go.dev/github.com/en-vee/go-diameter/v4) is an
...
See the API documentation at https://pkg.go.dev/github.com/en-vee/go-diameter/v4
...
go run github.com/en-vee/go-diameter/v4/examples/server
go run github.com/en-vee/go-diameter/v4/examples/client -hello
```

Without modules, use standard procedure:

```
go get github.com/en-vee/go-diameter/examples/...
go run github.com/en-vee/go-diameter/examples/server
go run github.com/en-vee/go-diameter/examples/client -hello
```
